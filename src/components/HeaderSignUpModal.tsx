...
interface HeaderSignUpModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSignUpSuccess: () => void;
}

const HeaderSignUpModal = ({ isOpen, onClose, onSignUpSuccess }: HeaderSignUpModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store pending profile data using direct insert
      console.log('Inserting pending profile...');
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
              Create your profile to start building your professional network
            </p>
          </div>
...
export default HeaderSignUpModal;