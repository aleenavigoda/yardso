/*
  # Fix Pending Time Transactions Logic with Nudge Feature

  1. Update get_pending_time_transactions function to show transactions for both logger and recipient
  2. Add nudge functionality for loggers
  3. Keep confirm/dispute for recipients only
  4. Add proper tracking of nudges
*/
...
-- Update the get_pending_time_transactions function to show for both parties
