...
DROP FUNCTION IF EXISTS create_invitation_with_time_log(uuid, text, text, text, numeric, text, text, text);
...
-- Drop existing notification function to recreate with enhancements
DROP FUNCTION IF EXISTS create_transaction_notification() CASCADE;
...
-- Recreate the triggers with the enhanced function
